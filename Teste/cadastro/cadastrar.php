        ...
        <div class="bg-primary">
            ...
            <body>
                <div class="container bg-primary-subtle border border-primary-subtle rounded-3">
                    <a class="btn btn-light mt-2" href="../">Voltar</a>
                 <h1 class="text-center">Cadastrar Conta</h1>
                 <br/>   
                ...
                <form class="text-center" method='post'>
                    ...
                    <input class="form-control mb-3 mx-auto p-2" style="width: 200px;" type='text' name='login' required/>
                    ...
                    <label class="form-label">Digite novamente a sua senha</label>
                    <input class="form-control mb-5 mx-auto p-2" style="width: 200px;" type='password' name='repetir' required />
